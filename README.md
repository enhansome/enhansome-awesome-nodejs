...
*Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 507,497 | 🐛 106 | 📅 2026-09-02 list thing, going deeper down the rabbit hole. 🐰*
...
* [Node.js](https://github.com/sindresorhus/awesome-nodejs) ⭐ 66,848 | 🐛 25 | 📅 2026-09-02 - The core awesome list for Node.js.
...
* [Docker](https://github.com/veggiemonk/awesome-docker) ⭐ 36,848 | 🐛 34 | 📅 2026-09-12 - Everything about Docker, from general articles to community meetups.
* [Kubernetes](https://github.com/ramitsurana/awesome-kubernetes) ⭐ 16,084 | 🐛 92 | 🌐 Shell | 📅 2026-09-03 - A bountiful resource to begin orchestrating containerized applications with Kubernetes.
...
* [React](https://github.com/enaqx/awesome-react) ⭐ 74,643 | 🐛 11 | 📅 2026-09-04 - List of resources for React, covering just about every concept, methodology, and implementation in the React ecosystem.
* [Vue](https://github.com/vuejs/awesome-vue) ⭐ 73,546 | 🐛 82 | 📅 2026-09-18 - Selection of both official and community Vue.js examples, tooling, snippets, components, and projects.
...
* [Electron](https://github.com/sindresorhus/awesome-electron) ⭐ 27,286 | 🐛 7 | 📅 2026-05-03 - A suite of of resources for building with [Electron](electron.atom.io).
