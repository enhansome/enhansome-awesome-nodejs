...
*Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 507,854 | 🐛 106 | 📅 2026-09-02 list thing, going deeper down the rabbit hole. 🐰*
...
* [Node.js](https://github.com/sindresorhus/awesome-nodejs) ⭐ 66,857 | 🐛 25 | 📅 2026-09-02 - The core awesome list for Node.js.
...
* [JavaScript](https://github.com/sorrycc/awesome-javascript) ⭐ 35,030 | 🐛 24 | 📅 2026-09-08 - A central list of *everything* JavaScript.
...
* [Docker](https://github.com/veggiemonk/awesome-docker) ⭐ 36,852 | 🐛 36 | 📅 2026-09-12 - Everything about Docker, from general articles to community meetups.
* [Kubernetes](https://github.com/ramitsurana/awesome-kubernetes) ⭐ 16,083 | 🐛 92 | 🌐 Shell | 📅 2026-09-03 - A bountiful resource to begin orchestrating containerized applications with Kubernetes.
...
* [React](https://github.com/enaqx/awesome-react) ⭐ 74,650 | 🐛 11 | 📅 2026-09-04 - List of resources for React, covering just about every concept, methodology, and implementation in the React ecosystem.
* [Vue](https://github.com/vuejs/awesome-vue) ⭐ 73,547 | 🐛 80 | 📅 2026-09-18 - Selection of both official and community Vue.js examples, tooling, snippets, components, and projects.
* [React Native](https://github.com/jondot/awesome-react-native) ⭐ 35,700 | 🐛 21 | 📅 2026-08-26 - Comprehensive collection of resources React Native.
